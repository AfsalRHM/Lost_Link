...
request_route.post("/getUserRedeemRequests", requestController.getUserRedeemRequests); // To get all the redeem requests to show in the profile
...
/*************************      Admin Side       *******************************/
// Get Requests
request_route.get("/admin/all", requestController.getAllRequests); // To get all the requests in the admin side
