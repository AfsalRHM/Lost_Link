...
const accessTokenSecret = process.env.JWT_ACCESS_SECRETKEY;
const refreshTokenSecret = process.env.JWT_REFRESH_SECRETKEY;
...
export default class jwtFunctions {
  ...
  static generateRefreshToken(admin: jwtPayload): string {
    return jwt.sign(admin, refreshTokenSecret!, {
